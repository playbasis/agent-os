...
pnpm pbos evidence-dashboard improve [--paths 20] [--variants 6] [--critique-rounds 3] [--region-critique] [--timestamp YYYYMMDDTHHMMSSZ] [--skip-browser]
...
improvement trace, and snapshot bundle. `--region-critique` additionally asks a
